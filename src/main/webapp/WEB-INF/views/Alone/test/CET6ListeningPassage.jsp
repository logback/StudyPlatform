    ...
    <div class="nk-main clearfix" >
        <div class="module-box subject-box">
            <div class="nowcoder-topic" >
                ...
                <div class="subject-title">[听力短文]</div>
                <div class="subject-main" >
                    <div class="subject-content" >
                        <button class="layui-btn" style="display: none" onclick="playMusic()">播放</button>
                        <audio id="players" controls="controls" autoplay="autoplay">
                            <source src="<%=basePath%>assets/alone/sound/changduihua.mp3"/>
                        </audio>
                    </div>
...
<script >
    ...
    function locaDato(pageIndex){
        if(pageIndex!=0) {
            $(function () {
                $.ajax({
                    url: '<%=basePath%>start/cet6listeningpassage',
                    type: 'post',
                    dataType: "json",
    ...
    function playMusic()
    {
        let player = $("#players")[0]; /*jquery对象转换成js对象*/
