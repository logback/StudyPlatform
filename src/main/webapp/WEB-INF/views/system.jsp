    ...
    <div class="main-inner">
        <div class="main-list">
            ...
            <div class="main-list__wrapper clearfix">
                ...
                <a href="<%=basePath%>start/test/HomePage"><img src="<%=basePath%>assets/graceful/images/conts/main-list__img1.jpg" alt="#"><span>练习</span></a>
                <a href="<%=basePath%>start/reception/search"><img src="<%=basePath%>assets/graceful/images/conts/main-list__img2.jpg" alt="#"><span>查词</span></a>
                <a href="<%=basePath%>start/aaa"><img src="<%=basePath%>assets/graceful/images/conts/main-list__img3.jpg" alt="#"><span>资源</span></a>
                <a href="<%=basePath%>game/gamehome"><img src="<%=basePath%>assets/graceful/images/conts/main-list__img4.jpg" alt="#"><span>游戏</span></a>
