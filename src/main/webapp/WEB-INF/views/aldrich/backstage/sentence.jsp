    ...
    <div class="header">
        <div class="demoTable" style="width: 1100px">
            <blockquote class="layui-elem-quote">
                ...
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input class="layui-input" id="adminName" type="text" placeholder="关键词">
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    layui.use(['table','laydate','form'],function(){
        ...
        table.render({
            elem: '#test'
            ,url:'<%=basePath%>sentence/getSentences'
            ,toolbar: '#toolbarDemo'
            , method: 'POST'
            ,title: '单词信息数据表'
            ,width:1100
            ...
            ,cols: [[
                ...
                ,{field:'typeName', title:'类型名', width:120,unresize: true}
                ,{field:'content', title:'内容', width:120,sort: true}
                ,{field:'translate', title:'翻译', width:120}
