...
<script type="text/html" id="actor">
    {{#if(d.role==='1001'){ }}
    <span style="color: #189F92;font-weight: bolder">VIP用户 </span>
    {{# } else { }}
    <span style="color: #393D49;font-weight: bolder">普通用户</span>
    {{#  } }}
</script>
...
<script type="text/javascript">
    ...
    let state = "${sessionScope.Admin.state}";
    ...
    layui.use(['table','laydate','form'],function(){
        ...
        form.on('switch(state)', function(data){
            if(role==1001&&state=="已授权"){
                ...
                $.ajax({
                    type: 'POST',
                    url: '<%=basePath%>user/submit/authorize',
                    dataType: 'json',
            ...
            switch(obj.event){
                case 'delete':
                    if(role===1001&&state==="已授权") {
                        ...
                        $.post('<%=basePath%>user/deleteByIds',
                            {'accounts': accounts},
                            function (data) {
