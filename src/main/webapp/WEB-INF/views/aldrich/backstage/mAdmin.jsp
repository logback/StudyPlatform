            ...
            <form class="layui-form layui-form-pane"
                ...
                <div class="layui-form-item" pane>
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="role" value="1001" title="超级管理员">
                        <input type="radio" name="role" value="1002" title="系统管理员">
                        <input type="radio" name="role" value="1003" title="基本管理员">
                    </div>
                </div>
                    ...
                    <div class="detail-left">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <span class="spans" id="role">系统管理员</span>
                            </li>
                            <li>
                                <label class="desc">授权</label>
                                <span class="spans" id="authorize">已授权</span>
                            </li>
                            <li>
...
<script type="text/javascript">
    ...
    /*依据account获取管理员详细信息*/
    function getAdminByAccount(url)
    {
        $.ajax({
            url:url,
            dataType:"json",
    ...
    $(document).ready(function () {
        ...
        if(account===null){
            ...
            url="<%=basePath%>admin/getAdminByAccount";
            getAdminByAccount(url);
        }
