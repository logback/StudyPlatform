...
let tabFilter,menu=[],liIndex,curNav,delMenu;
layui.define(["element","jquery"],function(exports){
	...
	$("body").on("click",".top_tab li i.layui-tab-close",function(){
        ...
        let curmenu = window.sessionStorage.getItem("curmenu")==="undefined" ? "undefined" : window.sessionStorage.getItem("curmenu")==="" ? '' : JSON.parse(window.sessionStorage.getItem("curmenu"));
