...
layui.use(['form','jquery',"layer"],function() {
    ...
    if(window.sessionStorage.getItem('userFace') &&  $(".userAvatar").length > 0){
        ...
        $("#userFace").attr("src","https://aldrich.oss-cn-beijing.aliyuncs.com/image/StudyPlatform/avatar/20181214214118596.jpg");
    }
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src="https://aldrich.oss-cn-beijing.aliyuncs.com/image/StudyPlatform/avatar/20181214214118596.jpg" class="userAvatar"/></div>'+
                            '<div class="admin-header-lock-name" id="lockUserName">Aldrich</div>'+
                            '<div class="input_btn">'+
